...
export const startMasterController = (account: Uint8Array) => {
  ...
  setInterval(async () => {
    ...
    try {
      ...
      Log().error("[Papa] Master Reconciliation Failed:", error);
    } finally {
